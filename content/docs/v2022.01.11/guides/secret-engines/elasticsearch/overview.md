...
![Elasticsearch secret engine](/docs/v2022.01.11/images/guides/secret-engines/elasticsearch/elasticsearch_secret_engine_guide.svg)

You need to be familiar with the following CRDs:

- [AppBinding](/docs/v2022.01.11/concepts/vault-server-crds/auth-methods/appbinding)
- [SecretEngine](/docs/v2022.01.11/concepts/secret-engine-crds/secretengine)
...
Now, we have the [AppBinding](/docs/v2022.01.11/concepts/vault-server-crds/auth-methods/appbinding) that contains connection and authentication information about the Vault server.
...
When a [SecretEngine](/docs/v2022.01.11/concepts/secret-engine-crds/secretengine) crd object is created, the KubeVault operator will enable a secret engine on specified path and configure the secret engine with given configurations.
...
By using [ElasticsearchRole](/docs/v2022.01.11/concepts/secret-engine-crds/database-secret-engine/elasticsearch), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/elasticdb#setup) on the Vault server in Kubernetes native way.
...
> Don't have Vault CLI? Download and configure it as described [here](/docs/v2022.01.11/guides/vault-server/vault-server#enable-vault-cli)
