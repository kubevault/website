...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2022.01.11/examples/guides/secret-engines/azure) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
