...
To use file system as storage backend in Vault server, specify the `spec.backend.file` in [VaultServer](/docs/v2022.01.11/concepts/vault-server-crds/vaultserver) CRD.
