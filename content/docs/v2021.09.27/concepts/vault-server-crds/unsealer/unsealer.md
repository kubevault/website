...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2021.09.27/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2021.09.27/concepts/vault-server-crds/unsealer/kubernetes_secret)
