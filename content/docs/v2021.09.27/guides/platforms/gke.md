...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2021.09.27/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2021.09.27/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2021.09.27/images/guides/provider/gke/gke-unseal-keys.png)
