...
![DatabaseAccessRequest CRD](/docs/v2020.07.09-rc.0/images/concepts/database_accesskey_request.svg)
...
`spec.roleRef` is a `required` field that specifies the reference to a database Role CR (i.e.[MongoDBRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/database-secret-engine/mongodb),
[PostgresRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/database-secret-engine/postgresrole),
[MySQLRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/database-secret-engine/mysql)) against which credentials will be issued.
