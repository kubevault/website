...
When a `GCPAccessKeyRequest` is created, it make an  access key request to Vault under a `roleset`. Hence a [GCPRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/gcp-secret-engine/gcprole) CRD is a prerequisite for creating a `GCPAccessKeyRequest`.

![GCPAccessKeyRequest CRD](/docs/v2020.07.09-rc.0/images/concepts/gcp_accesskey_request.svg)
...
[GCPRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/gcp-secret-engine/gcprole) and subjects.
...
[GCPRole](/docs/v2020.07.09-rc.0/concepts/secret-engine-crds/gcp-secret-engine/gcprole) against which credentials will be issued.
