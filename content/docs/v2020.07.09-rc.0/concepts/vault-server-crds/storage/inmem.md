...
To use In-Memory as storage backend in Vault specify `spec.backend.inmem` in [VaultServer](/docs/v2020.07.09-rc.0/concepts/vault-server-crds/vaultserver) CRD.
