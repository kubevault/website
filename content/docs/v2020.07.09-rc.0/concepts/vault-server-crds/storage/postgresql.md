...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2020.07.09-rc.0/concepts/vault-server-crds/vaultserver) CRD.
