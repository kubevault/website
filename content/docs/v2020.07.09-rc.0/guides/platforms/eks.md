...
- You should be familiar with the following CRD:
  ...
  - [awsKmsSsm](/docs/v2020.07.09-rc.0/concepts/vault-server-crds/unsealer/aws_kms_ssm)
...
![aws ec2 instance](/docs/v2020.07.09-rc.0/images/guides/provider/eks/aws-instance.png)
...
![unseal keys](/docs/v2020.07.09-rc.0/images/guides/provider/eks/unseal-keys.png)
