...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2020.07.09-rc.0/examples/guides/secret-engines/kv) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
