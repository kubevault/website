...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while install Vault CSI driver.  To know details about how to enable monitoring see [here](/docs/v2020.07.09-rc.0/guides/monitoring/overview#how-to-enable-monitoring)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2020.07.09-rc.0/images/monitoring/csi-vault-prom-builtin.png">
  </kbd>
</p>
