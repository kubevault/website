...
Enable Prometheus monitoring using `prometheus.io/builtin` annotations while install KubeVault operator.  To know details about how to enable monitoring see [here](/docs/v2026.8.7/guides/monitoring/overview#how-to-enable-monitoring)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2026.8.7/images/monitoring/vault-operator-builtin.png">
  </kbd>
</p>
