...
[//]: # ()
[//]: # ( <img alt="Vault Backup" src="/docs/v2026.8.7/guides/backup-restore-kubestash/images/backup-chk.png">)
...
Up next:
- Read about step-by-step Restore procedure [here](/docs/v2026.8.7/guides/backup-restore-kubestash/restore)