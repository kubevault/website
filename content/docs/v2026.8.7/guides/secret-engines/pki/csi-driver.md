...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2026.8.7/examples/guides/secret-engines/pki) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
