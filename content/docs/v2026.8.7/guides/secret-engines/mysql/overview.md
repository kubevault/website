...
![MySQL secret engine](/docs/v2026.8.7/images/guides/secret-engines/mysql/mysql_secret_engine_guide.svg)
...
By using [MySQLRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/mysql), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mysql-maria#setup) on the Vault server in Kubernetes native way.
