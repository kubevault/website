...
url: /docs/v2026.8.7/concepts/
aliases:
- /docs/v2026.8.7/concepts/README/
info:
  cli: v0.25.0
  installer: v2026.8.7
  operator: v0.25.0
...
- What is KubeVault?
  - [Overview](/docs/v2026.8.7/concepts/overview). Provides an introduction to KubeVault operator, including the problems it solves and its use cases.
  - [Operator architecture](/docs/v2026.8.7/concepts/architecture). Provides a high-level illustration of the architecture of the KubeVault operator.
...
- [AppBinding](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/appbinding)

## Vault Server Version

Introduces the concept of `VaultServerVersion` to specify the docker images of `HashiCorp Vault`, `Unsealer`, and `Exporter`.

- [VaultServerVersion](/docs/v2026.8.7/concepts/vault-server-crds/vaultserverversion)
...
- [VaultServer](/docs/v2026.8.7/concepts/vault-server-crds/vaultserver)
...
- [VaultRelay](/docs/v2026.8.7/concepts/vault-server-crds/vaultrelay)
...
- [NamespaceSlice](/docs/v2026.8.7/concepts/vault-server-crds/namespaceslice)
...
- [Overview](/docs/v2026.8.7/concepts/vault-server-crds/unsealer/overview)
- [AWS KMS and SSM](/docs/v2026.8.7/concepts/vault-server-crds/unsealer/aws_kms_ssm)
- [Azure Key Vault](/docs/v2026.8.7/concepts/vault-server-crds/unsealer/azure_key_vault)
- [Google KMS GCS](/docs/v2026.8.7/concepts/vault-server-crds/unsealer/google_kms_gcs)
- [Kubernetes Secret](/docs/v2026.8.7/concepts/vault-server-crds/unsealer/kubernetes_secret)
...
- [Overview](/docs/v2026.8.7/concepts/vault-server-crds/storage/overview)
- [Azure](/docs/v2026.8.7/concepts/vault-server-crds/storage/azure)
- [DynamoDB](/docs/v2026.8.7/concepts/vault-server-crds/storage/dynamodb)
- [Etcd](/docs/v2026.8.7/concepts/vault-server-crds/storage/etcd)
- [GCS](/docs/v2026.8.7/concepts/vault-server-crds/storage/gcs)
- [In Memory](/docs/v2026.8.7/concepts/vault-server-crds/storage/inmem)
- [MySQL](/docs/v2026.8.7/concepts/vault-server-crds/storage/mysql)
- [PosgreSQL](/docs/v2026.8.7/concepts/vault-server-crds/storage/postgresql)
- [AWS S3](/docs/v2026.8.7/concepts/vault-server-crds/storage/s3)
- [Swift](/docs/v2026.8.7/concepts/vault-server-crds/storage/swift)
- [Consul](/docs/v2026.8.7/concepts/vault-server-crds/storage/consul)
- [Raft](/docs/v2026.8.7/concepts/vault-server-crds/storage/raft)
...
- [Overview](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/overview)
- [AWS IAM Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/aws-iam)
- [Kubernetes Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/kubernetes)
- [TLS Certificates Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/tls)
- [Token Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/token)
- [Userpass Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/userpass)
- [GCP IAM Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/gcp-iam)
- [Azure Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/azure)
- [JWT/OIDC Auth Method](/docs/v2026.8.7/concepts/vault-server-crds/auth-methods/jwt-oidc)
...
- [Secret Engine](/docs/v2026.8.7/concepts/secret-engine-crds/secretengine)
...
- [AWSRole](/docs/v2026.8.7/concepts/secret-engine-crds/aws-secret-engine/awsrole)
- [GCPRole](/docs/v2026.8.7/concepts/secret-engine-crds/gcp-secret-engine/gcprole)
- [AzureRole](/docs/v2026.8.7/concepts/secret-engine-crds/azure-secret-engine/azurerole)
- [PKIRole](/docs/v2026.8.7/concepts/secret-engine-crds/pki-secret-engine/pkirole)
- [MongoDBRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/mongodb)
- [MySQLRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/mysql)
- [PostgresRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/postgres)
- [ElasticsearchRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/elasticsearch)
- [MariaDBRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/mariadb)
- [RedisRole](/docs/v2026.8.7/concepts/secret-engine-crds/database-secret-engine/redis)
...
- [SecretAccessRequest](/docs/v2026.8.7/concepts/secret-engine-crds/secret-access-request)
...
- [SecretRoleBinding](/docs/v2026.8.7/concepts/secret-engine-crds/secret-role-binding)
...
- [VaultPolicy](/docs/v2026.8.7/concepts/policy-crds/vaultpolicy): is used to create, update or delete Vault policies.
- [VaultPolicyBinding](/docs/v2026.8.7/concepts/policy-crds/vaultpolicybinding): is used to create Vault auth roles associated with an authentication type/entity and a set of Vault policies.
