...
![ElasticsearchRole CRD](/docs/v2026.8.7/images/concepts/elasticsearch_role.svg)
...
namespace once [tenant isolation](/docs/v2026.8.7/guides/tenant-isolation/overview) has placed
