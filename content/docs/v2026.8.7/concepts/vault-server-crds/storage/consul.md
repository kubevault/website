...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v2026.8.7/concepts/vault-server-crds/vaultserver) CRD.
