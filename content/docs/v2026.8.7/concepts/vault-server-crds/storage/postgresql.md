...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2026.8.7/concepts/vault-server-crds/vaultserver) CRD.
