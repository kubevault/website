...
To use In-Memory as storage backend in Vault specify `spec.backend.inmem` in [VaultServer](/docs/v2024.1.26-rc.0/concepts/vault-server-crds/vaultserver) CRD.
