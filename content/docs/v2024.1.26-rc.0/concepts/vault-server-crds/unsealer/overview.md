...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2024.1.26-rc.0/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2024.1.26-rc.0/concepts/vault-server-crds/unsealer/kubernetes_secret)
