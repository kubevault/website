...
![Azure secret engine](/docs/v2024.1.26-rc.0/images/guides/secret-engines/azure/azure_secret_engine_guide.svg)
...
By using [AzureRole](/docs/v2024.1.26-rc.0/concepts/secret-engine-crds/azure-secret-engine/azurerole), you can create a [role](https://www.vaultproject.io/api/secret/azure/index.html#create-update-role) on the Vault server in Kubernetes native way.
