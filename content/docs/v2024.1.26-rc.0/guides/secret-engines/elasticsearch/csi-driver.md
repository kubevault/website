...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2024.1.26-rc.0/examples/guides/secret-engines/elasticsearch) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
