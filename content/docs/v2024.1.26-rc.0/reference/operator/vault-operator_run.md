...
```
      ...
      --authentication-configmap-namespace string               Namespace of extension-apiserver-authentication configmap (default "kube-system")
...
* [vault-operator](/docs/v2024.1.26-rc.0/reference/operator/vault-operator)	 - Vault Operator by AppsCode - HashiCorp Vault Operator for Kubernetes
