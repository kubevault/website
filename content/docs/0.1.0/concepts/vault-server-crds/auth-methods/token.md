...
In Vault operator, usually Vault connection information are handled by [AppBinding](/docs/0.1.0/concepts/vault-server-crds/auth-methods/appbinding). To perform [Token Authentication](https://www.vaultproject.io/docs/auth/token.html#token-auth-method),
