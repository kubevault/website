...
## spec.unsealer
To use Unsealer specify `spec.unsealer` in [VaultServer](/docs/0.1.0/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/0.1.0/concepts/vault-server-crds/unsealer/kubernetes_secret)
