...
* [vault approve](/docs/0.1.0/reference/cli/vault_approve)	 - Approve request
* [vault deny](/docs/0.1.0/reference/cli/vault_deny)	 - Deny request
* [vault version](/docs/0.1.0/reference/cli/vault_version)	 - Prints binary version number.
