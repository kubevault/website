...
url: /docs/0.1.0/reference/operator/
aliases:
- /docs/0.1.0/reference/operator/vault-operator/
info:
  version: 0.1.0
---
...
* [vault-operator run](/docs/0.1.0/reference/operator/vault-operator_run)	 - Launch Vault operator
* [vault-operator version](/docs/0.1.0/reference/operator/vault-operator_version)	 - Prints binary version number.
