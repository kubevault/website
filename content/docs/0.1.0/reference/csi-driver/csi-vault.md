...
url: /docs/0.1.0/reference/csi-driver/
aliases:
- /docs/0.1.0/reference/csi-driver/csi-vault/
info:
  version: 0.1.0
---
...
* [csi-vault run](/docs/0.1.0/reference/csi-driver/csi-vault_run)	 - Run Vault CSI driver
* [csi-vault version](/docs/0.1.0/reference/csi-driver/csi-vault_version)	 - Prints binary version number.
