...
- You should be familiar with the following CRD:
  ...
  - [awsKmsSsm](/docs/0.1.0/concepts/vault-server-crds/unsealer/aws_kms_ssm)
...
![aws ec2 instance](/docs/0.1.0/images/guides/provider/eks/aws-instance.png)
...
![unseal keys](/docs/0.1.0/images/guides/provider/eks/unseal-keys.png)
