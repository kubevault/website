...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/0.1.0/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/0.1.0/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/0.1.0/images/guides/provider/gke/gke-unseal-keys.png)
