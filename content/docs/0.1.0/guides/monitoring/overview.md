...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/0.1.0/images/vault-prometheus.jpg">
</p>
...
- Learn how to monitor Vault operator using built-in Prometheus from [here](/docs/0.1.0/guides/monitoring/builtin).
- Learn how to monitor Vault operator using CoreOS Prometheus operator from [here](/docs/0.1.0/guides/monitoring/coreos).
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/0.1.0/guides/monitoring/grafana).
