...
Follow [this](/docs/0.1.0/guides/secret-engines/kv/overview) tutorial to manage Key/Value secrets with `Vault operator`. After successful configuration you should have following resources present in your cluster.
