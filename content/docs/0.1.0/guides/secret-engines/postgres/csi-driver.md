...
Follow [this](/docs/0.1.0/guides/secret-engines/postgres/overview) tutorial to manage PostgreSQL credentials with `Vault operator`. After successful configuration you should have following resources present in your cluster.
