...
Follow [this](/docs/0.1.0/guides/secret-engines/pki/overview) tutorial to manage PKI(certificates) secrets with `Vault operator`. After successful configuration you should have following resources present in your cluster.
