...
Follow [this](/docs/0.1.0/guides/secret-engines/aws/overview) tutorial to manage AWS IAM secrets with `Vault operator`. After successful configuration you should have following resources present in your cluster.
