...
* [vault root-token delete](/docs/v2022.02.22/reference/cli/vault_root-token_delete)	 - delete vault root-token
* [vault root-token get](/docs/v2022.02.22/reference/cli/vault_root-token_get)	 - get vault root-token
* [vault root-token set](/docs/v2022.02.22/reference/cli/vault_root-token_set)	 - set vault root-token
* [vault root-token sync](/docs/v2022.02.22/reference/cli/vault_root-token_sync)	 - sync vault root-token
