...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2022.02.22/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2022.02.22/concepts/vault-server-crds/unsealer/kubernetes_secret)
- [googleKmsGcs](/docs/v2022.02.22/concepts/vault-server-crds/unsealer/google_kms_gcs)
- [awsKmsSsm](/docs/v2022.02.22/concepts/vault-server-crds/unsealer/aws_kms_ssm)
