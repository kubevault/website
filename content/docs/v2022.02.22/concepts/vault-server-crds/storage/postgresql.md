...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2022.02.22/concepts/vault-server-crds/vaultserver) CRD.
