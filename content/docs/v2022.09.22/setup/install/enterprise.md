...
<figure align="center">
  <img alt="KubeVault Backend Overview" src="/docs/v2022.09.22/images/setup/enterprise_license_form.png">
  <figcaption align="center">Fig: KubeVault License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing KubeVault by following the upgrading guide from [here](/docs/v2022.09.22/setup/upgrade/#updating-license).
...
Now, you are ready to [create your first database](/docs/v2022.09.22/guides/README) using KubeVault.
