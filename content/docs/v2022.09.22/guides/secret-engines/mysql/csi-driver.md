...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2022.09.22/examples/guides/secret-engines/mysql) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
