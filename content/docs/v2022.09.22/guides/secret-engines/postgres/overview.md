...
![PostgreSQL secret engine](/docs/v2022.09.22/images/guides/secret-engines/postgresql/postgres_secret_engine_guide.svg)
...
By using [PostgresRole](/docs/v2022.09.22/concepts/secret-engine-crds/database-secret-engine/postgresrole), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/postgresql#setup) on the Vault server in Kubernetes native way.
