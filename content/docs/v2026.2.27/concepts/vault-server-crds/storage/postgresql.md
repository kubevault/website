...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2026.2.27/concepts/vault-server-crds/vaultserver) CRD.
