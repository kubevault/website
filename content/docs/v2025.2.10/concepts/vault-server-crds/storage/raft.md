...
To use `Raft` as backend storage in Vault, we need to specify `spec.backend.raft` in [VaultServer](/docs/v2025.2.10/concepts/vault-server-crds/vaultserver) CRD.
