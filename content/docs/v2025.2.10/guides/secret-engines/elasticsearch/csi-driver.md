...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2025.2.10/examples/guides/secret-engines/elasticsearch) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
