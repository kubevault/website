...
`KubeVault` supports number of different [Storage Backend](/docs/v2024.1.28-rc.1/concepts/vault-server-crds/storage/overview) types. Therefore, the exact steps to backup Vault will depend on your
...
Read more about `AppBinding` [here](/docs/v2024.1.28-rc.1/concepts/vault-server-crds/appbinding).
...
- Read about step-by-step Restore procedure [here](/docs/v2024.1.28-rc.1/guides/backup-restore/restore)
