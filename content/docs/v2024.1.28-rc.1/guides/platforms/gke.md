...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2024.1.28-rc.1/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2024.1.28-rc.1/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2024.1.28-rc.1/images/guides/provider/gke/gke-unseal-keys.png)
