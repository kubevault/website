...
![MongoDB secret engine](/docs/v2024.1.28-rc.1/images/guides/secret-engines/mongodb/mongodb_secret_engine_guide.svg)
...
By using [MongoDBRole](/docs/v2024.1.28-rc.1/concepts/secret-engine-crds/database-secret-engine/mongodb), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mongodb#setup) on the Vault server in Kubernetes native way.
