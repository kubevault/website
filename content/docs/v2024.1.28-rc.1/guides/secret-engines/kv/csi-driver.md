...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2024.1.28-rc.1/examples/guides/secret-engines/kv) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
