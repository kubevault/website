...
To use dynamoDB as backend storage in Vault specify `spec.backend.dynamodb` in [VaultServer](/docs/v2024.1.28-rc.1/concepts/vault-server-crds/vaultserver) CRD.
