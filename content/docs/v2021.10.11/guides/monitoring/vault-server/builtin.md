...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2021.10.11/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2021.10.11/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
