...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2024.3.12/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2024.3.12/concepts/vault-server-crds/unsealer/kubernetes_secret)
