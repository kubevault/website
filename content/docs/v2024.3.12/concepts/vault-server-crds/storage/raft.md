...
To use `Raft` as backend storage in Vault, we need to specify `spec.backend.raft` in [VaultServer](/docs/v2024.3.12/concepts/vault-server-crds/vaultserver) CRD.
