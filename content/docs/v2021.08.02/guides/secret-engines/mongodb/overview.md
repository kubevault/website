...
![MongoDB secret engine](/docs/v2021.08.02/images/guides/secret-engines/mongodb/mongodb_secret_engine_guide.svg)
...
To configure the MongoDB secret engine, you need to provide the MongoDB connection information through an [AppBinding](/docs/v2021.08.02/concepts/vault-server-crds/auth-methods/appbinding).
...
By using [MongoDBRole](/docs/v2021.08.02/concepts/secret-engine-crds/database-secret-engine/mongodb), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mongodb#setup) on the Vault server in Kubernetes native way.
