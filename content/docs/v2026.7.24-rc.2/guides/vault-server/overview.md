...
- **Vault Policy Management**: Provides a Kubernetes native way to manage Vault policies and bind those policies to the users or the auth method roles.
  ...
  - [Vault Policy](/docs/v2026.7.24-rc.2/guides/policy-management/overview#vaultpolicy)
  - [Vault Policy Binding](/docs/v2026.7.24-rc.2/guides/policy-management/overview#vaultpolicybinding)

- **Vault Secret Engine Management**: Provides a Kubernetes native way to manage Vault secret engines.

  - [GCP Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/gcp/overview)
  - [AWS Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/aws/overview)
  - [Azure Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/azure/overview)
  - Database Secret Engine
    - [MongoDB Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/mongodb/overview)
    - [MySQL Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/mysql/overview)
    - [PostgreSQL Secret Engine](/docs/v2026.7.24-rc.2/guides/secret-engines/postgres/overview)

## Setup Vault Server

![Overview](/docs/v2026.7.24-rc.2/images/guides/vault-server/overview_vault_server_guide.svg)
...
- [Enable Vault CLI](/docs/v2026.7.24-rc.2/guides/vault-server/vault-server#enable-vault-cli)

 Configure external Vault server so that the  KubeVault operator can communicate with it:

- [Configure Cluster and External Vault Server](/docs/v2026.7.24-rc.2/guides/vault-server/external-vault-sever)
