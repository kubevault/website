...
[Hub-Spoke Deployment](/docs/v2026.7.24-rc.2/guides/hub-spoke/)), tenant isolation extends to the spoke: the
...
[NamespaceSlice concept](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/namespaceslice) for its full CRD
...
- [Deploy Vault in a Hub-Spoke Model](/docs/v2026.7.24-rc.2/guides/hub-spoke/)
- [Secret Engine Guides](/docs/v2026.7.24-rc.2/guides/secret-engines/)
