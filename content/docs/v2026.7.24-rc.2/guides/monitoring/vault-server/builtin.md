...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2026.7.24-rc.2/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2026.7.24-rc.2/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
