...
[//]: # ()
[//]: # ( <img alt="Vault Backup" src="/docs/v2026.7.24-rc.2/guides/backup-restore-kubestash/images/backup-chk.png">)
...
Up next:
- Read about step-by-step Restore procedure [here](/docs/v2026.7.24-rc.2/guides/backup-restore-kubestash/restore)