...
- If you are not familiar with how Stash backup and restore Vault cluster, please check the following concept section [here](/docs/v2026.7.24-rc.2/concepts/backup-restore/overview).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/appbinding)
...
Read more about `AppBinding` [here](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/appbinding).
...
<figure align="center">
 <img alt="Vault Backup" src="/docs/v2026.7.24-rc.2/images/guides/backup-restore/backup.png">
  <figcaption align="center">Fig: Vault Backup</figcaption>
</figure>


Up next:
- Read about step-by-step Restore procedure [here](/docs/v2026.7.24-rc.2/guides/backup-restore/restore)