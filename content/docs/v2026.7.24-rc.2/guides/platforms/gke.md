...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2026.7.24-rc.2/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2026.7.24-rc.2/images/guides/provider/gke/gke-unseal-keys.png)
