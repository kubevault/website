...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/unsealer/kubernetes_secret)
