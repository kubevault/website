...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/vaultserver) CRD.
