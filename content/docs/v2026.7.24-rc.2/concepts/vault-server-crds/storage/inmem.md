...
To use In-Memory as storage backend in Vault specify `spec.backend.inmem` in [VaultServer](/docs/v2026.7.24-rc.2/concepts/vault-server-crds/vaultserver) CRD.
