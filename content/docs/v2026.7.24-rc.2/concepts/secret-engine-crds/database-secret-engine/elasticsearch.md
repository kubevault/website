...
![ElasticsearchRole CRD](/docs/v2026.7.24-rc.2/images/concepts/elasticsearch_role.svg)
...
namespace once [tenant isolation](/docs/v2026.7.24-rc.2/guides/tenant-isolation/overview) has placed
