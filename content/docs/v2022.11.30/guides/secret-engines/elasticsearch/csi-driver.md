...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2022.11.30/examples/guides/secret-engines/elasticsearch) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
