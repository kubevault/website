...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v2024.1.31/concepts/vault-server-crds/vaultserver) CRD.
