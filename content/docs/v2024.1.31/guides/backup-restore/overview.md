...
`KubeVault` supports number of different [Storage Backend](/docs/v2024.1.31/concepts/vault-server-crds/storage/overview) types. Therefore, the exact steps to backup Vault will depend on your
...
Up next:
- Read about step-by-step Backup procedure [here](/docs/v2024.1.31/guides/backup-restore/backup)
