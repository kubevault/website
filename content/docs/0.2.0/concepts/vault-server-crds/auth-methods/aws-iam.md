...
- You have to specify IAM auth type [role](https://www.vaultproject.io/api/auth/aws/index.html#create-role) name in `spec.parameters` of the [AppBinding](/docs/0.2.0/concepts/vault-server-crds/auth-methods/appbinding).
    ```yaml
    spec:
      parameters:
