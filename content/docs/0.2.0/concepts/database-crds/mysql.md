...
`spec.databaseRef` is a required field that specifies the name of [AppBinding](/docs/0.2.0/concepts/vault-server-crds/auth-methods/appbinding) that contains mysql database connection information. This should be in the same namespace of the `MySQLRole` CRD.
