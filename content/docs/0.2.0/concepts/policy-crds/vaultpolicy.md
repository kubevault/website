...
`spec.vaultAppRef` is a required field that specifies name and namespace of [AppBinding](/docs/0.2.0/concepts/vault-server-crds/auth-methods/appbinding) that contains information to communicate with Vault.
