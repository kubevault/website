...
Follow [this](/docs/0.2.0/guides/secret-engines/mongodb/overview) tutorial to manage MongoDB credentials with `Vault operator`. After successful configuration you should have following resources present in your cluster.
