...
Follow [this](/docs/0.2.0/guides/secret-engines/mysql/overview) tutorial to manage MySql/MariaDB credentials with `Vault operator`. After successful configuration you should have following resources present in your cluster.
