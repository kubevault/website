...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/0.2.0/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/0.2.0/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
