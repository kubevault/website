...
In this tutorial, we are going to use this AppBinding to authenticate against the Vault. See [here](/docs/0.2.0/concepts/vault-server-crds/auth-methods/overview) for Vault authentication using AppBinding in Vault operator.
