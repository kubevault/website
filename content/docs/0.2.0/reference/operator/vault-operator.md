...
* [vault-operator run](/docs/0.2.0/reference/operator/vault-operator_run)	 - Launch Vault operator
* [vault-operator version](/docs/0.2.0/reference/operator/vault-operator_version)	 - Prints binary version number.
