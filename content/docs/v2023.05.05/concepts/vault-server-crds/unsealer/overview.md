...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2023.05.05/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2023.05.05/concepts/vault-server-crds/unsealer/kubernetes_secret)
