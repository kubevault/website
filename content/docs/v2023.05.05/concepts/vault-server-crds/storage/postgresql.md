...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2023.05.05/concepts/vault-server-crds/vaultserver) CRD.
