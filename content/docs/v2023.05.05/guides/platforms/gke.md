...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2023.05.05/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2023.05.05/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2023.05.05/images/guides/provider/gke/gke-unseal-keys.png)
