...
![Redis secret engine](/docs/v2023.05.05/images/guides/secret-engines/redis/redis_secret_engine_guide.svg)
...
By using [RedisRole](/docs/v2023.05.05/concepts/secret-engine-crds/database-secret-engine/redis), you can create a [role](https://developer.hashicorp.com/vault/docs/secrets/databases/redis#setup) on the Vault server in Kubernetes native way.
