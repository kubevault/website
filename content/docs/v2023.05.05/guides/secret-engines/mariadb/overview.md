...
![MariaDB secret engine](/docs/v2023.05.05/images/guides/secret-engines/mariadb/mariadb_secret_engine_guide.svg)
...
By using [MariaDBRole](/docs/v2023.05.05/concepts/secret-engine-crds/database-secret-engine/mariadb), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mysql-maria#setup) on the Vault server in Kubernetes native way.
