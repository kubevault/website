...
url: /docs/v2025.11.21/concepts/
aliases:
- /docs/v2025.11.21/concepts/README/
info:
  cli: v0.23.0
...
- What is KubeVault?
  - [Overview](/docs/v2025.11.21/concepts/overview). Provides an introduction to KubeVault operator, including the problems it solves and its use cases.
  - [Operator architecture](/docs/v2025.11.21/concepts/architecture). Provides a high-level illustration of the architecture of the KubeVault operator.
