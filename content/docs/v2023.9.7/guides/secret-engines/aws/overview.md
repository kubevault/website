...
![AWS secret engine](/docs/v2023.9.7/images/guides/secret-engines/aws/aws_secret_engine_guide.svg)
...
By using [AWSRole](/docs/v2023.9.7/concepts/secret-engine-crds/aws-secret-engine/awsrole), you can create a [role](https://www.vaultproject.io/api/secret/aws/index.html#create-update-role) on the Vault server in Kubernetes native way.
