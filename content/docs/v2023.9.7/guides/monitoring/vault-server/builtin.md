...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2023.9.7/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2023.9.7/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
