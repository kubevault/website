...
`KubeVault` supports number of different [Storage Backend](/docs/v2023.9.7/concepts/vault-server-crds/storage/overview) types. Therefore, the exact steps to backup Vault will depend on your
