...
- Install KubeVault in your cluster following the steps [here](/docs/v2024.9.30/setup/README).
...
- If you are not familiar with how Stash backup and restore Vault cluster, please check the following concept section [here](/docs/v2024.9.30/concepts/backup-restore/overview).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2024.9.30/concepts/vault-server-crds/appbinding)
...
<figure align="center">
 <img alt="Vault Backup" src="/docs/v2024.9.30/images/guides/backup-restore/backup.png">
