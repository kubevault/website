...
Enable Prometheus monitoring using `prometheus.io/builtin` annotations while install KubeVault operator.  To know details about how to enable monitoring see [here](/docs/v2024.9.30/guides/monitoring/overview#how-to-enable-monitoring)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2024.9.30/images/monitoring/vault-operator-builtin.png">
  </kbd>
</p>
