...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2024.9.30/examples/guides/secret-engines/mariadb) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
