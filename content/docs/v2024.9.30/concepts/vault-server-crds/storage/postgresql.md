...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2024.9.30/concepts/vault-server-crds/vaultserver) CRD.
