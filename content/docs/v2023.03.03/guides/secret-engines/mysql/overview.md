...
![MySQL secret engine](/docs/v2023.03.03/images/guides/secret-engines/mysql/mysql_secret_engine_guide.svg)
...
By using [MySQLRole](/docs/v2023.03.03/concepts/secret-engine-crds/database-secret-engine/mysql), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mysql-maria#setup) on the Vault server in Kubernetes native way.
