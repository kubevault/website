...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2023.03.03/examples/guides/secret-engines/mongodb) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
