...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2022.06.16/concepts/vault-server-crds/vaultserver) CRD.
