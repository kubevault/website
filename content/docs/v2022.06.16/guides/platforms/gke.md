...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2022.06.16/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2022.06.16/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2022.06.16/images/guides/provider/gke/gke-unseal-keys.png)
