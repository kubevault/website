...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2020.07.09-beta.0/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2020.07.09-beta.0/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
