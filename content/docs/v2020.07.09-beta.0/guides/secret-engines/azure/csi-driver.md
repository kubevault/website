...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2020.07.09-beta.0/examples/guides/secret-engines/azure) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/docs)
