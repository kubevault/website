...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2020.07.09-beta.0/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2020.07.09-beta.0/concepts/vault-server-crds/unsealer/kubernetes_secret)
