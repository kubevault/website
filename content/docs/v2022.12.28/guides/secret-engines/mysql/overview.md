...
![MySQL secret engine](/docs/v2022.12.28/images/guides/secret-engines/mysql/mysql_secret_engine_guide.svg)
...
By using [MySQLRole](/docs/v2022.12.28/concepts/secret-engine-crds/database-secret-engine/mysql), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mysql-maria#setup) on the Vault server in Kubernetes native way.
