...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2022.12.28/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2022.12.28/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
