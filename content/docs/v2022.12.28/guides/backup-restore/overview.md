...
`KubeVault` supports number of different [Storage Backend](/docs/v2022.12.28/concepts/vault-server-crds/storage/overview) types. Therefore, the exact steps to backup Vault will depend on your
...
Read more about `AppBinding` [here](/docs/v2022.12.28/concepts/vault-server-crds/appbinding).
...
- Read about step-by-step Restore procedure [here](/docs/v2022.12.28/guides/backup-restore/restore)
