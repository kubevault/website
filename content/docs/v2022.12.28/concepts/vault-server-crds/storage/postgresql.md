...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2022.12.28/concepts/vault-server-crds/vaultserver) CRD.
