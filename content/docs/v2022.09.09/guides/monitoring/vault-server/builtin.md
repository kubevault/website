...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2022.09.09/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2022.09.09/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
