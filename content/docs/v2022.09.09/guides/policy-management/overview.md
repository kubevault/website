...
- [VaultPolicy](/docs/v2022.09.09/concepts/policy-crds/vaultpolicy)
- [VaultPolicyBinding](/docs/v2022.09.09/concepts/policy-crds/vaultpolicybinding)
...
- Deploy the Vault server or configure an existing one.
  - [Setup Vault Server](/docs/v2022.09.09/guides/vault-server/overview#setup-vault-server)
...
![Vault Policy](/docs/v2022.09.09/images/guides/policy-management/vault_policy.svg)
...
> Don't have Vault CLI? Enable Vault CLI from [here](/docs/v2022.09.09/guides/vault-server/vault-server#enable-vault-cli).
...
![Vault Policy](/docs/v2022.09.09/images/guides/policy-management/vault_policy_binding.svg)
...
> Don't have Vault CLI? Download and configure it as described [here](/docs/v2022.09.09/guides/policy-management/../vault-server/vault-server#enable-vault-cli).
