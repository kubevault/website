...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2022.09.09/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2022.09.09/concepts/vault-server-crds/unsealer/kubernetes_secret)
