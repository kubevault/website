...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2025.2.6-rc.0/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2025.2.6-rc.0/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
