...
![MariaDB secret engine](/docs/v2025.2.6-rc.0/images/guides/secret-engines/mariadb/mariadb_secret_engine_guide.svg)
...
By using [MariaDBRole](/docs/v2025.2.6-rc.0/concepts/secret-engine-crds/database-secret-engine/mariadb), you can create a [role](https://www.vaultproject.io/docs/secrets/databases/mysql-maria#setup) on the Vault server in Kubernetes native way.
