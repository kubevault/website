...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2025.2.6-rc.0/examples/guides/secret-engines/mariadb) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
