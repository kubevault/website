...
To use dynamoDB as backend storage in Vault specify `spec.backend.dynamodb` in [VaultServer](/docs/v2025.2.6-rc.0/concepts/vault-server-crds/vaultserver) CRD.
