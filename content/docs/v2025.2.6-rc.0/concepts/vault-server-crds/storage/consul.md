...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v2025.2.6-rc.0/concepts/vault-server-crds/vaultserver) CRD.
