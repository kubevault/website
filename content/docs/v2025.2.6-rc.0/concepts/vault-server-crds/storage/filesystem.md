...
To use file system as storage backend in Vault server, specify the `spec.backend.file` in [VaultServer](/docs/v2025.2.6-rc.0/concepts/vault-server-crds/vaultserver) CRD.
