...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2022.12.09/examples/guides/secret-engines/elasticsearch) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
