...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v2022.12.09/concepts/vault-server-crds/vaultserver) CRD.
