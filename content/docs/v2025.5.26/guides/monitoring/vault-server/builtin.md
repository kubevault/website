...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v2025.5.26/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2025.5.26/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
