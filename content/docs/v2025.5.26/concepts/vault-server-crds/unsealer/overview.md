...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2025.5.26/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2025.5.26/concepts/vault-server-crds/unsealer/kubernetes_secret)
