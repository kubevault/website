...
To use `Raft` as backend storage in Vault, we need to specify `spec.backend.raft` in [VaultServer](/docs/v2025.5.26/concepts/vault-server-crds/vaultserver) CRD.
