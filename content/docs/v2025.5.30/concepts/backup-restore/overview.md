...
<figure align="center">
 <img alt="Vault Backup Overview" src="/docs/v2025.5.30/images/concepts/backup.svg">
...
3. Then, the user creates a `BackupConfiguration` crd targeting the [AppBinding CRD](/docs/v2025.5.30/concepts/vault-server-crds/auth-methods/appbinding) of the desired Vault cluster. The `BackupConfiguration` object also specifies the `Task` to use to take backup of the Vault cluster.
...
<figure align="center">
 <img alt="Vault Restore Overview" src="/docs/v2025.5.30/images/concepts/restore.svg">
...
- Backup your Vault cluster using Stash following the guide from [here](/docs/v2025.5.30/guides/backup-restore/overview).
