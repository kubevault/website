...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2025.5.30/examples/guides/secret-engines/azure) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
