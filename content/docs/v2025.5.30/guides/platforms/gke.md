...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2025.5.30/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2025.5.30/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2025.5.30/images/guides/provider/gke/gke-unseal-keys.png)
