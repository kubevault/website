...
`KubeVault` supports number of different [Storage Backend](/docs/v2025.5.30/concepts/vault-server-crds/storage/overview) types. Therefore, the exact steps to backup Vault will depend on your
...
Up next:
- Read about step-by-step Backup procedure [here](/docs/v2025.5.30/guides/backup-restore/backup)
