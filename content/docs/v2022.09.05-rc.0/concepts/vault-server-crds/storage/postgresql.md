...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2022.09.05-rc.0/concepts/vault-server-crds/vaultserver) CRD.
