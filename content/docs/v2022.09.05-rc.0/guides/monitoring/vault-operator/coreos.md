...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing KubeVault operator. To know details about how to enable monitoring see [here](/docs/v2022.09.05-rc.0/guides/monitoring/overview#how-to-enable-monitoring)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v2022.09.05-rc.0/images/monitoring/vault-operator-coreos.png">
  </kbd>
</p>
