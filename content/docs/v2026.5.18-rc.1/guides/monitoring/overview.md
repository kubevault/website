...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/v2026.5.18-rc.1/images/vault-prometheus.jpg">
</p>
...
- Learn how to monitor Vault server using built-in Prometheus from [here](/docs/v2026.5.18-rc.1/guides/monitoring/vault-server/builtin).
- Learn how to monitor Vault server using CoreOS Prometheus operator from [here](/docs/v2026.5.18-rc.1/guides/monitoring/vault-server/coreos).
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/v2026.5.18-rc.1/guides/monitoring/vault-server/grafana).
- Learn how to monitor KubeVault operator using built-in Prometheus from [here](/docs/v2026.5.18-rc.1/guides/monitoring/vault-operator/builtin).
- Learn how to monitor KubeVault operator using CoreOS Prometheus operator from [here](/docs/v2026.5.18-rc.1/guides/monitoring/vault-operator/coreos).
