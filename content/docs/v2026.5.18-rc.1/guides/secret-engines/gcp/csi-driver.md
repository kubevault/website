...
> Note: YAML files used in this tutorial stored in [examples](/docs/v2026.5.18-rc.1/examples/guides/secret-engines/gcp) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/kubevault)
