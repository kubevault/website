...
- You should be familiar with the following CRD:
  ...
  - [awsKmsSsm](/docs/v2026.5.18-rc.1/concepts/vault-server-crds/unsealer/aws_kms_ssm)
...
![aws ec2 instance](/docs/v2026.5.18-rc.1/images/guides/provider/eks/aws-instance.png)
...
![unseal keys](/docs/v2026.5.18-rc.1/images/guides/provider/eks/unseal-keys.png)
