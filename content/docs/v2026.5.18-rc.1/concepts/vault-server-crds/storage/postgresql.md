...
To use PostgreSQL as backend storage in Vault specify `spec.backend.postgresql` in [VaultServer](/docs/v2026.5.18-rc.1/concepts/vault-server-crds/vaultserver) CRD.
