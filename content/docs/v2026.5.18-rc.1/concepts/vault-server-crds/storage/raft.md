...
To use `Raft` as backend storage in Vault, we need to specify `spec.backend.raft` in [VaultServer](/docs/v2026.5.18-rc.1/concepts/vault-server-crds/vaultserver) CRD.
