...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2026.5.18-rc.1/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2026.5.18-rc.1/concepts/vault-server-crds/unsealer/kubernetes_secret)
