...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v2026.1.8-rc.0/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v2026.1.8-rc.0/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v2026.1.8-rc.0/images/guides/provider/gke/gke-unseal-keys.png)
