...
To use dynamoDB as backend storage in Vault specify `spec.backend.dynamodb` in [VaultServer](/docs/v2026.1.8-rc.0/concepts/vault-server-crds/vaultserver) CRD.
