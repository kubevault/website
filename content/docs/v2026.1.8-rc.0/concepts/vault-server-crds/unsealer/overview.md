...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v2026.1.8-rc.0/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v2026.1.8-rc.0/concepts/vault-server-crds/unsealer/kubernetes_secret)
