...
> Note: YAML files used in this tutorial are stored in [docs/examples](/docs/v0.3.0/examples)
...
<p align="center">
  <kbd>
    <img alt="builtin-prom-vault"  src="/docs/v0.3.0/images/monitoring/builtin-prom-vault.jpg">
  </kbd>
</p>
