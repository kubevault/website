...
- You should be familiar with the following CRD:
  ...
  - [googleKmsGcs](/docs/v0.3.0/concepts/vault-server-crds/unsealer/google_kms_gcs)
...
![gke instance](/docs/v0.3.0/images/guides/provider/gke/gke-cluster.png)
...
![unseal keys](/docs/v0.3.0/images/guides/provider/gke/gke-unseal-keys.png)
