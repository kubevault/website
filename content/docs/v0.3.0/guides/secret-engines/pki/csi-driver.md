...
Follow [this](/docs/v0.3.0/guides/secret-engines/pki/overview) tutorial to manage PKI(certificates) secrets with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
