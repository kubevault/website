...
<p align="center">
  <img alt="AWS IAM Policy" src="/docs/v0.3.0/images/csi-driver-policy-aws.jpg" style="padding: 10px;">
</p>
...
Follow [this](/docs/v0.3.0/guides/secret-engines/aws/overview) tutorial to manage AWS IAM secrets with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
