...
Follow [this](/docs/v0.3.0/guides/secret-engines/mysql/overview) tutorial to manage MySql/MariaDB credentials with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
