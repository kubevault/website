...
![MySQL secret engine](/docs/v0.3.0/images/guides/secret-engines/mysql/mysql_secret_engine_guide.svg)
...
To configure the MySQL secret engine, you need to provide the MySQL database connection and authentication information through an [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding).
...
By using [MySQLRole](/docs/v0.3.0/concepts/secret-engine-crds/database-secret-engine/mysql), you can create a [role](https://www.vaultproject.io/api/secret/mysql/index.html#create-role) on the Vault server in Kubernetes native way.
