...
Follow [this](/docs/v0.3.0/guides/secret-engines/postgres/overview) tutorial to manage PostgreSQL credentials with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
