...
> Note: YAML files used in this tutorial stored in [examples](/docs/v0.3.0/examples/csi-driver/azure) folder in github repository [KubeVault/docs](https://github.com/kubevault/docs)
...
Before creating [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding), we need to create a service account that has the permission to read Azure secret in vault.
