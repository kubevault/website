...
> Note: YAML files used in this tutorial stored in [examples](/docs/v0.3.0/examples/guides/secret-engines/mongodb) folder in GitHub repository [KubeVault/docs](https://github.com/kubevault/docs)
