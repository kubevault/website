...
![MongoDB secret engine](/docs/v0.3.0/images/guides/secret-engines/mongodb/mongodb_secret_engine_guide.svg)
...
To configure the MongoDB secret engine, you need to provide the MongoDB connection information through an [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding).
...
By using [MongoDBRole](/docs/v0.3.0/concepts/secret-engine-crds/database-secret-engine/mongodb), you can create a [role](https://www.vaultproject.io/api/secret/mongodb/index.html#create-role) on the Vault server in Kubernetes native way.
