...
Follow [this](/docs/v0.3.0/guides/secret-engines/kv/overview) tutorial to manage Key/Value secrets with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
