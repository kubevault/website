...
Before creating [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding), we need to create a service account that has the permission to read GCP secret in vault.
