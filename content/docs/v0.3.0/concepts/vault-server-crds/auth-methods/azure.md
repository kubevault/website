...
- You have to specify `spec.secret` in the [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding).
...
- You have to specify the name of Azure [role](https://www.vaultproject.io/api/auth/azure/index.html#create-role) name in `spec.parameters` of the [AppBinding](/docs/v0.3.0/concepts/vault-server-crds/auth-methods/appbinding).
