...
To use Unsealer, configure `spec.unsealer` field in [VaultServer](/docs/v0.3.0/concepts/vault-server-crds/vaultserver) CRD .
...
- [kubernetesSecret](/docs/v0.3.0/concepts/vault-server-crds/unsealer/kubernetes_secret)
