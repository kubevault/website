...
To use Consul as backend storage in Vault, we need to specify `spec.backend.consul` in [VaultServer](/docs/v0.3.0/concepts/vault-server-crds/vaultserver) CRD.
