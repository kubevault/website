...
![AWSAccessKeyRequest CRD](/docs/v0.3.0/images/concepts/aws_accesskey_request.svg)
...
`spec.roleRef` is a `required` field that specifies the [AWSRole](/docs/v0.3.0/concepts/secret-engine-crds/aws-secret-engine/awsrole) against which credentials will be issued.
